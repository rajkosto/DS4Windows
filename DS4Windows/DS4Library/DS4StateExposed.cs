...
namespace DS4Windows
{
    public class DS4StateExposed
    {
        ...
        public int AccelX { get { return (Motion == null) ? 0 : (int)(Motion.accelX * DS4Cal.ACC_RESOLUTION_PER_G); } }
        public int AccelY { get { return (Motion == null) ? 0 : (int)(Motion.accelY * DS4Cal.ACC_RESOLUTION_PER_G); } }
        public int AccelZ { get { return (Motion == null) ? 0 : (int)(Motion.accelZ * DS4Cal.ACC_RESOLUTION_PER_G); } }
        public int GyroX { get { return (Motion == null) ? 0 : (int)(Motion.gyroPitch * DS4Cal.GYRO_RESOLUTION_IN_DEG_SEC); } }
        public int GyroY { get { return (Motion == null) ? 0 : (int)(Motion.gyroYaw * DS4Cal.GYRO_RESOLUTION_IN_DEG_SEC); } }
        public int GyroZ { get { return (Motion == null) ? 0 : (int)(Motion.gyroRoll * DS4Cal.GYRO_RESOLUTION_IN_DEG_SEC); } }
    }
}
