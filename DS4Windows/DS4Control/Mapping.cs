            ...
            if (sOff == false)
            {
                ...
                if (SXD > 0 || SXMax < 1.0 || sxAntiDead > 0)
                {
                    ...
                    if (absx > SXD)
                    {
                        ...
                        dState.Motion.fakeAccelX = Math.Sign(gyroX) *
                            (int)Math.Min(128d, sxsens * 128d * ((1.0 - sxAntiDead) * ratioX + sxAntiDead));
                    }
                    else
                    {
                        dState.Motion.fakeAccelX = 0;
                    }
                }
                else
                {
                ...
                if (SZD > 0 || SZMax < 1.0 || szAntiDead > 0)
                {
                    ...
                    if (absz > SZD)
                    {
                        ...
                        dState.Motion.fakeAccelZ = Math.Sign(gyroZ) *
                            (int)Math.Min(128d, szsens * 128d * ((1.0 - szAntiDead) * ratioZ + szAntiDead));
                    }
                    else
                    {
                        dState.Motion.fakeAccelZ = 0;
                    }
                }
                else
                {
                ...
                if (sxOutCurveMode > 0)
                {
                    ...
                    {
                        double output = temp * temp;
                        dState.Motion.fakeAccelX = (byte)(output * sign * 128.0);
                    }
                    else if (sxOutCurveMode == 2)
                    {
                        double output = temp * temp * temp;
                        dState.Motion.fakeAccelX = (byte)(output * 128.0);
                    }
                }
                ...
                if (szOutCurveMode > 0)
                {
                    ...
                    {
                        double output = temp * temp;
                        dState.Motion.fakeAccelZ = (byte)(output * sign * 128.0);
                    }
                    else if (szOutCurveMode == 2)
                    {
                        double output = temp * temp * temp;
                        dState.Motion.fakeAccelZ = (byte)(output * 128.0);
                    }
                }
            }
